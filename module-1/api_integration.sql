...
CREATE OR REPLACE SECRET course_repo.public.github_pat
  TYPE = password
  USERNAME = 'Z5-05'
  PASSWORD = '<replace-with-github-pat>';

-- Create the API integration
CREATE OR REPLACE API INTEGRATION git_api_integration
  API_PROVIDER = git_https_api
  API_ALLOWED_PREFIXES = ('https://github.com/Z5-05') -- URL to your GitHub profile
...
CREATE OR REPLACE GIT REPOSITORY course_repo.public.advanced_data_engineering_snowflake
  ...
  ORIGIN = 'https://github.com/Z5-05/advanced-data-engineering-snowflake.git' -- Insert URL of forked repo
